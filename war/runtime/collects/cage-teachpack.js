...
var start = function(offscreen_question_) { return (plt.Kernel.setLastLoc({offset:1929, line:56, span:274, id:"<unknown>"}) && plt.Kernel.apply(((function() {
   var _result_ = (function(args21) {
var update = args21[0];  return (plt.Kernel.setLastLoc({offset:2209, line:62, span:107, id:"<unknown>"}) && plt.world.MobyJsworld.bigBang((plt.Kernel.setLastLoc({offset:2222, line:62, span:20, id:"<unknown>"}) && make_dash_world(_SHARED[2],_SHARED[22])), [(plt.Kernel.setLastLoc({offset:2260, line:63, span:15, id:"<unknown>"}) && plt.world.config.Kernel.onKey(update)),(plt.Kernel.setLastLoc({offset:2293, line:64, span:22, id:"<unknown>"}) && plt.world.config.Kernel.onRedraw((plt.types.liftToplevelToFunctionValue(draw_dash_world,(plt.types.String.makeInstance("draw-world")),1,(plt.types.Rational.makeInstance(1, 1))))))])); });_result_._eqHashCode = plt.types.makeEqHashCode();_result_.toWrittenString = function (cache) { return '<function:lambda>'; };_result_.isEqual = function(other, cache) { return this === other; };_result_.procedureArity = (plt.types.Rational.makeInstance(1, 1));_result_.toDisplayedString = _result_.toWrittenString;return _result_;  })()),                    plt.Kernel.list([((function() {
...
var k = args23[1];  return ((plt.Kernel.setLastLoc({offset:2000, line:58, span:9, id:"<unknown>"}) && plt.Kernel.char_question_(k)) ?
 w :
 ((plt.Kernel.setLastLoc({offset:2035, line:59, span:123, id:"<unknown>"}) && plt.Kernel.apply(offscreen_question_,                     plt.Kernel.list([(plt.Kernel.setLastLoc({offset:2047, line:59, span:37, id:"<unknown>"}) && world_dash_x((plt.Kernel.setLastLoc({offset:2056, line:59, span:27, id:"<unknown>"}) && move(w,(plt.Kernel.setLastLoc({offset:2064, line:59, span:18, id:"<unknown>"}) && plt.Kernel.symbol_dash__greaterthan_string(k)))))), (plt.Kernel.setLastLoc({offset:2120, line:60, span:37, id:"<unknown>"}) && world_dash_y((plt.Kernel.setLastLoc({offset:2129, line:60, span:27, id:"<unknown>"}) && move(w,(plt.Kernel.setLastLoc({offset:2137, line:60, span:18, id:"<unknown>"}) && plt.Kernel.symbol_dash__greaterthan_string(k))))))]),                    [])) ?
 w :
 (plt.types.Logic.TRUE ?
 (plt.Kernel.setLastLoc({offset:2189, line:61, span:10, id:"<unknown>"}) && move(w,k)) :
 (plt.Kernel.setLastLoc({offset:1971, line:57, span:230, id:"<unknown>"}) && plt.Kernel.error((plt.types.Symbol.makeInstance("cond")),_SHARED[11]))))); });_result_._eqHashCode = plt.types.makeEqHashCode();_result_.toWrittenString = function (cache) { return '<function:lambda>'; };_result_.isEqual = function(other, cache) { return this === other; };_result_.procedureArity = (plt.types.Rational.makeInstance(2, 1));_result_.toDisplayedString = _result_.toWrittenString;return _result_;  })())]),                    [])); };_SHARED[3] = (plt.types.String.makeInstance("http://www.wescheme.org/images/teachpacks/butterfly.png"));
