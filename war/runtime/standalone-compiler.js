...
top_dash_env_dash_3 = (plt.Kernel.setLastLoc("offset=11722 line=329 span=1681 id=\"toplevel.ss\"") && plt.Kernel.foldl(((function() {
...
var loop = function(an_dash_env, contents) { return ((plt.Kernel.setLastLoc("offset=19604 line=404 span=17 id=\"modules.ss\"")   && plt.Kernel.empty_question_(contents)) ?
 an_dash_env :
 (plt.types.Logic.TRUE ?
 (plt.Kernel.setLastLoc("offset=19680 line=407 span=80 id=\"modules.ss\"")   && loop((plt.Kernel.setLastLoc("offset=19686 line=407 span=36 id=\"modules.ss\"")   && env_dash_extend(an_dash_env,(plt.Kernel.setLastLoc("offset=19705 line=407 span=16 id=\"modules.ss\"")   && plt.Kernel.first(contents)))),(plt.Kernel.setLastLoc("offset=19744 line=408 span=15 id=\"modules.ss\"")   && plt.Kernel.rest(contents)))) :
 (plt.Kernel.setLastLoc("offset=19583 line=403 span=179 id=\"modules.ss\"")   && plt.Kernel.error((plt.types.Symbol.makeInstance("cond")),(plt.types.String.makeInstance("cond: fell out of cond around \"offset=19583 line=403 span=179 id=\\\"modules.ss\\\"\"")))))); };
(function (toplevel_dash_expression_dash_show46) { 
 })(plt.Kernel.identity)
return (plt.Kernel.setLastLoc("offset=19769 line=409 span=56 id=\"modules.ss\"")   && loop(an_dash_env,(plt.Kernel.setLastLoc("offset=19782 line=409 span=42 id=\"modules.ss\"")   && module_dash_binding_dash_bindings(a_dash_module_dash_binding))));
              })()); };
...
var answer_dash_last = args106[3];
                             return (plt.Kernel.setLastLoc("offset=21670 line=433 span=109 id=\"desugar.ss\"") && plt.Kernel.list([(plt.Kernel.setLastLoc("offset=21676 line=433 span=50 id=\"desugar.ss\"")   && loop(questions,answers,question_dash_last,answer_dash_last)),pinfo])); });_result_.toWrittenString = function (cache) { return '<function:lambda>'; };_result_.procedureArity = (plt.types.Rational.makeInstance(4, 1));_result_.toDisplayedString = _result_.toWrittenString;return _result_;  })()))) :
 (plt.types.Logic.TRUE ?
...
var a_dash_clause = args116[0];
                             return (plt.Kernel.setLastLoc("offset=26132 line=535 span=24 id=\"desugar.ss\"")   && plt.Kernel.first((plt.Kernel.setLastLoc("offset=26139 line=535 span=16 id=\"desugar.ss\"")   && stx_dash_e(a_dash_clause)))); });_result_.toWrittenString = function (cache) { return '<function:lambda>'; };_result_.procedureArity = (plt.types.Rational.makeInstance(1, 1));_result_.toDisplayedString = _result_.toWrittenString;return _result_;  })()), [(plt.Kernel.setLastLoc("offset=26199 line=536 span=19 id=\"desugar.ss\"")   && stx_dash_e(clauses_dash_stx))]))));
...
var s = args118[0];
                             return ((plt.Kernel.setLastLoc("offset=29288 line=595 span=32 id=\"desugar.ss\"")   && stx_dash_begins_dash_with_question_(s,(plt.types.Symbol.makeInstance("quasiquote")))) ?
...
return (plt.Kernel.setLastLoc("offset=17074 line=349 span=1669 id=\"modules.ss\"")   && make_dash_module_dash_binding((plt.types.Symbol.makeInstance("jsworld")),module_dash_path,(plt.Kernel.setLastLoc("offset=17166 line=351 span=1576 id=\"modules.ss\"") && plt.Kernel.list([(plt.Kernel.setLastLoc("offset=17172 line=351 span=324 id=\"modules.ss\"")   && make_dash_binding_colon_function((plt.types.Symbol.makeInstance("js-big-bang")),module_dash_path,(plt.types.Rational.makeInstance(1, 1)),plt.types.Logic.TRUE,(plt.types.String.makeInstance("plt.world.MobyJsworld.bigBang")),plt.types.Empty.EMPTY,plt.types.Logic.FALSE)),(plt.Kernel.setLastLoc("offset=17528 line=359 span=421 id=\"modules.ss\"")   && make_dash_binding_colon_function((plt.types.Symbol.makeInstance("js-text")),module_dash_path,(plt.types.Rational.makeInstance(1, 1)),plt.types.Logic.FALSE,(plt.types.String.makeInstance("plt.world.MobyJsworld.text")),plt.types.Empty.EMPTY,plt.types.Logic.FALSE)),(plt.Kernel.setLastLoc("offset=18188 line=371 span=42 id=\"modules.ss\"")   && bf((plt.types.Symbol.makeInstance("js-div")),(plt.types.Rational.makeInstance(0, 1)),(plt.types.String.makeInstance("plt.world.MobyJsworld.div")))),(plt.Kernel.setLastLoc("offset=18262 line=372 span=38 id=\"modules.ss\"")   && bf((plt.types.Symbol.makeInstance("js-p")),(plt.types.Rational.makeInstance(0, 1)),(plt.types.String.makeInstance("plt.world.MobyJsworld.p")))),(plt.Kernel.setLastLoc("offset=18332 line=373 span=48 id=\"modules.ss\"")   && bf((plt.types.Symbol.makeInstance("js-button")),(plt.types.Rational.makeInstance(1, 1)),(plt.types.String.makeInstance("plt.world.MobyJsworld.button")))),(plt.Kernel.setLastLoc("offset=18412 line=374 span=53 id=\"modules.ss\"")   && bf((plt.types.Symbol.makeInstance("js-button!")),(plt.types.Rational.makeInstance(2, 1)),(plt.types.String.makeInstance("plt.world.MobyJsworld.buttonStar")))),(plt.Kernel.setLastLoc("offset=18497 line=375 span=46 id=\"modules.ss\"")   && bf((plt.types.Symbol.makeInstance("js-input")),(plt.types.Rational.makeInstance(2, 1)),(plt.types.String.makeInstance("plt.world.MobyJsworld.input")))),(plt.Kernel.setLastLoc("offset=18554 line=376 span=49 id=\"modules.ss\"")   && bf((plt.types.Symbol.makeInstance("js-img")),(plt.types.Rational.makeInstance(1, 1)),(plt.types.String.makeInstance("plt.world.MobyJsworld.img")))),(plt.Kernel.setLastLoc("offset=18635 line=378 span=47 id=\"modules.ss\"")   && bf((plt.types.Symbol.makeInstance("js-node")),(plt.types.Rational.makeInstance(1, 1)),(plt.types.String.makeInstance("plt.world.MobyJsworld.rawNode")))),(plt.Kernel.setLastLoc("offset=18693 line=379 span=48 id=\"modules.ss\"")   && bf((plt.types.Symbol.makeInstance("js-select")),(plt.types.Rational.makeInstance(2, 1)),(plt.types.String.makeInstance("plt.world.MobyJsworld.select"))))]))));
              })());
moby_dash_module_dash_binding = (plt.Kernel.setLastLoc("offset=18877 line=387 span=401 id=\"modules.ss\"")   && make_dash_module_dash_binding((plt.types.Symbol.makeInstance("moby")),(plt.types.String.makeInstance("moby/moby")),(plt.Kernel.setLastLoc("offset=18962 line=389 span=315 id=\"modules.ss\"") && plt.Kernel.append((plt.Kernel.setLastLoc("offset=18995 line=390 span=43 id=\"modules.ss\"")   && module_dash_binding_dash_bindings(world_dash_stub_dash_module)), [(plt.Kernel.setLastLoc("offset=19063 line=391 span=40 id=\"modules.ss\"")   && module_dash_binding_dash_bindings(jsworld_dash_module)),(plt.Kernel.setLastLoc("offset=19128 line=392 span=42 id=\"modules.ss\"")   && module_dash_binding_dash_bindings(telephony_dash_module)),(plt.Kernel.setLastLoc("offset=19195 line=393 span=41 id=\"modules.ss\"")   && module_dash_binding_dash_bindings(location_dash_module)),(plt.Kernel.setLastLoc("offset=19240 line=394 span=36 id=\"modules.ss\"")   && module_dash_binding_dash_bindings(net_dash_module))]))));

known_dash_modules = (plt.Kernel.setLastLoc("offset=19853 line=413 span=397 id=\"modules.ss\"") && plt.Kernel.list([world_dash_module,world_dash_stub_dash_module,location_dash_module,tilt_dash_module,net_dash_module,parser_dash_module,bootstrap_dash_module,telephony_dash_module,moby_dash_module_dash_binding]));
