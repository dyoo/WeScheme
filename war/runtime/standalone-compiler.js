...
var loop = function(an_dash_env, contents) { return ((plt.Kernel.setLastLoc("offset=19522 line=402 span=17 id=\"modules.ss\"")   && plt.Kernel.empty_question_(contents)) ?
 an_dash_env :
 (plt.types.Logic.TRUE ?
 (plt.Kernel.setLastLoc("offset=19598 line=405 span=80 id=\"modules.ss\"")   && loop((plt.Kernel.setLastLoc("offset=19604 line=405 span=36 id=\"modules.ss\"")   && env_dash_extend(an_dash_env,(plt.Kernel.setLastLoc("offset=19623 line=405 span=16 id=\"modules.ss\"")   && plt.Kernel.first(contents)))),(plt.Kernel.setLastLoc("offset=19662 line=406 span=15 id=\"modules.ss\"")   && plt.Kernel.rest(contents)))) :
 (plt.Kernel.setLastLoc("offset=19501 line=401 span=179 id=\"modules.ss\"")   && plt.Kernel.error((plt.types.Symbol.makeInstance("cond")),(plt.types.String.makeInstance("cond: fell out of cond around \"offset=19501 line=401 span=179 id=\\\"modules.ss\\\"\"")))))); };
(function (toplevel_dash_expression_dash_show44) { 
 })(plt.Kernel.identity)
return (plt.Kernel.setLastLoc("offset=19687 line=407 span=56 id=\"modules.ss\"")   && loop(an_dash_env,(plt.Kernel.setLastLoc("offset=19700 line=407 span=42 id=\"modules.ss\"")   && module_dash_binding_dash_bindings(a_dash_module_dash_binding))));
              })()); };
...
var id = args86[0];
var fields = args86[1];
                             return (plt.Kernel.setLastLoc("offset=3815 line=69 span=28 id=\"desugar.ss\"") && plt.Kernel.list([(plt.Kernel.setLastLoc("offset=3821 line=69 span=13 id=\"desugar.ss\"") && plt.Kernel.list([a_dash_defn])),a_dash_pinfo])); });_result_.toWrittenString = function (cache) { return '<function:lambda>'; };_result_.procedureArity = (plt.types.Rational.makeInstance(2, 1));_result_.toDisplayedString = _result_.toWrittenString;return _result_;  })())));
              })()); };
...
test_dash_exprs = (plt.Kernel.setLastLoc("offset=5666 line=110 span=45 id=\"desugar.ss\"") && plt.Kernel.map((function() { var _result_ = (function(_args_) {
                    return thunkify_dash_stx(_args_[0]);});_result_.toWrittenString = function(cache) {return '<function:thunkify-stx>'; };_result_.toDisplayedString = _result_.toWrittenString; _result_.procedureArity = (plt.types.Rational.makeInstance(1, 1));return _result_; })(), [(plt.Kernel.setLastLoc("offset=5684 line=110 span=26 id=\"desugar.ss\"")   && plt.Kernel.rest((plt.Kernel.setLastLoc("offset=5690 line=110 span=19 id=\"desugar.ss\"")   && stx_dash_e(a_dash_test_dash_case))))]));
...
var else_dash_stx = args103[0];
                             return (plt.Kernel.setLastLoc("offset=21130 line=422 span=40 id=\"desugar.ss\"")   && make_dash_stx_colon_atom((plt.types.Symbol.makeInstance("true")),(plt.Kernel.setLastLoc("offset=21151 line=422 span=18 id=\"desugar.ss\"")   && stx_dash_loc(else_dash_stx)))); });_result_.toWrittenString = function (cache) { return '<function:lambda>'; };_result_.procedureArity = (plt.types.Rational.makeInstance(1, 1));_result_.toDisplayedString = _result_.toWrittenString;return _result_;  })()),((function() {
...
var answer_dash_last = args104[3];
                             return (plt.Kernel.setLastLoc("offset=21304 line=424 span=109 id=\"desugar.ss\"") && plt.Kernel.list([(plt.Kernel.setLastLoc("offset=21310 line=424 span=50 id=\"desugar.ss\"")   && loop(questions,answers,question_dash_last,answer_dash_last)),pinfo])); });_result_.toWrittenString = function (cache) { return '<function:lambda>'; };_result_.procedureArity = (plt.types.Rational.makeInstance(4, 1));_result_.toDisplayedString = _result_.toWrittenString;return _result_;  })()))) :
 (plt.types.Logic.TRUE ?
...
var process_dash_clauses = function(clauses, questions_slash_rev, answers_slash_rev) { return ((plt.Kernel.setLastLoc("offset=22001 line=439 span=40 id=\"desugar.ss\"")   && stx_dash_begins_dash_with_question_((plt.Kernel.setLastLoc("offset=22019 line=439 span=15 id=\"desugar.ss\"")   && plt.Kernel.first(clauses)),(plt.types.Symbol.makeInstance("else")))) ?
 ...
 (plt.Kernel.setLastLoc("offset=22215 line=442 span=188 id=\"desugar.ss\"")  && plt.Kernel.apply(f,                        plt.Kernel.list([(plt.Kernel.setLastLoc("offset=22218 line=442 span=23 id=\"desugar.ss\"")   && plt.Kernel.reverse(questions_slash_rev)), (plt.Kernel.setLastLoc("offset=22260 line=443 span=21 id=\"desugar.ss\"")   && plt.Kernel.reverse(answers_slash_rev)), (plt.Kernel.setLastLoc("offset=22300 line=444 span=52 id=\"desugar.ss\"")  && plt.Kernel.apply(else_dash_replacement_dash_f,                        plt.Kernel.list([(plt.Kernel.setLastLoc("offset=22320 line=444 span=31 id=\"desugar.ss\"")   && plt.Kernel.first((plt.Kernel.setLastLoc("offset=22327 line=444 span=23 id=\"desugar.ss\"")   && stx_dash_e((plt.Kernel.setLastLoc("offset=22334 line=444 span=15 id=\"desugar.ss\"")   && plt.Kernel.first(clauses))))))]),                       [])), (plt.Kernel.setLastLoc("offset=22370 line=445 span=32 id=\"desugar.ss\"")   && plt.Kernel.second((plt.Kernel.setLastLoc("offset=22378 line=445 span=23 id=\"desugar.ss\"")   && stx_dash_e((plt.Kernel.setLastLoc("offset=22385 line=445 span=15 id=\"desugar.ss\"")   && plt.Kernel.first(clauses))))))]),                       []))) :
...
var clause = args107[0];
                             return (plt.Kernel.setLastLoc("offset=23238 line=468 span=22 id=\"desugar.ss\"")   && plt.Kernel.first((plt.Kernel.setLastLoc("offset=23245 line=468 span=14 id=\"desugar.ss\"")   && stx_dash_e(clause)))); });_result_.toWrittenString = function (cache) { return '<function:lambda>'; };_result_.procedureArity = (plt.types.Rational.makeInstance(1, 1));_result_.toDisplayedString = _result_.toWrittenString;return _result_;  })()), [(plt.Kernel.setLastLoc("offset=23289 line=469 span=19 id=\"desugar.ss\"")   && stx_dash_e(clauses_dash_stx))]));
...
var clause = args108[0];
                             return (plt.Kernel.setLastLoc("offset=23386 line=471 span=23 id=\"desugar.ss\"")   && plt.Kernel.second((plt.Kernel.setLastLoc("offset=23394 line=471 span=14 id=\"desugar.ss\"")   && stx_dash_e(clause)))); });_result_.toWrittenString = function (cache) { return '<function:lambda>'; };_result_.procedureArity = (plt.types.Rational.makeInstance(1, 1));_result_.toDisplayedString = _result_.toWrittenString;return _result_;  })()), [(plt.Kernel.setLastLoc("offset=23439 line=472 span=19 id=\"desugar.ss\"")   && stx_dash_e(clauses_dash_stx))]));
...
var a_dash_clause = args109[0];
                             return (plt.Kernel.setLastLoc("offset=23919 line=482 span=24 id=\"desugar.ss\"")   && plt.Kernel.first((plt.Kernel.setLastLoc("offset=23926 line=482 span=16 id=\"desugar.ss\"")   && stx_dash_e(a_dash_clause)))); });_result_.toWrittenString = function (cache) { return '<function:lambda>'; };_result_.procedureArity = (plt.types.Rational.makeInstance(1, 1));_result_.toDisplayedString = _result_.toWrittenString;return _result_;  })()), [(plt.Kernel.setLastLoc("offset=23986 line=483 span=19 id=\"desugar.ss\"")   && stx_dash_e(clauses_dash_stx))]))));
...
return (plt.Kernel.setLastLoc("offset=25499 line=521 span=88 id=\"desugar.ss\"")   && datum_dash__greaterthan_stx((plt.Kernel.setLastLoc("offset=25511 line=521 span=23 id=\"desugar.ss\"") && plt.Kernel.list([(plt.types.Symbol.makeInstance("define")),name,val])),(plt.Kernel.setLastLoc("offset=25568 line=522 span=18 id=\"desugar.ss\"")   && stx_dash_loc(a_dash_clause))));
              })()); });_result_.toWrittenString = function (cache) { return '<function:lambda>'; };_result_.procedureArity = (plt.types.Rational.makeInstance(1, 1));_result_.toDisplayedString = _result_.toWrittenString;return _result_;  })()), [(plt.Kernel.setLastLoc("offset=25607 line=523 span=19 id=\"desugar.ss\"")   && stx_dash_e(clauses_dash_stx))])); })(plt.Kernel.identity)
...
var a_dash_clause = args114[0];
                             return (plt.Kernel.setLastLoc("offset=25766 line=526 span=24 id=\"desugar.ss\"")   && plt.Kernel.first((plt.Kernel.setLastLoc("offset=25773 line=526 span=16 id=\"desugar.ss\"")   && stx_dash_e(a_dash_clause)))); });_result_.toWrittenString = function (cache) { return '<function:lambda>'; };_result_.procedureArity = (plt.types.Rational.makeInstance(1, 1));_result_.toDisplayedString = _result_.toWrittenString;return _result_;  })()), [(plt.Kernel.setLastLoc("offset=25833 line=527 span=19 id=\"desugar.ss\"")   && stx_dash_e(clauses_dash_stx))]))));
...
return (plt.Kernel.setLastLoc("offset=29839 line=599 span=18 id=\"desugar.ss\"")   && plt.Kernel.second((plt.Kernel.setLastLoc("offset=29847 line=599 span=9 id=\"desugar.ss\"")   && stx_dash_e(s))));})() :
 ...
 (plt.Kernel.setLastLoc("offset=28870 line=585 span=1416 id=\"desugar.ss\"")   && plt.Kernel.error((plt.types.Symbol.makeInstance("cond")),(plt.types.String.makeInstance("cond: fell out of cond around \"offset=28870 line=585 span=1416 id=\\\"desugar.ss\\\"\"")))))))); });_result_.toWrittenString = function (cache) { return '<function:lambda>'; };_result_.procedureArity = (plt.types.Rational.makeInstance(1, 1));_result_.toDisplayedString = _result_.toWrittenString;return _result_;  })()), [(plt.Kernel.setLastLoc("offset=30329 line=606 span=13 id=\"desugar.ss\"")   && stx_dash_e(a_dash_stx))])))),(plt.Kernel.setLastLoc("offset=30379 line=607 span=15 id=\"desugar.ss\"")   && stx_dash_loc(a_dash_stx)))) :
...
var definition_dash__greaterthan_javascript_dash_strings = function(defn, env, a_dash_pinfo) { return (plt.Kernel.setLastLoc("offset=6531 line=145 span=307 id=\"beginner-to-javascript.ss\"")   && case_dash_analyze_dash_definition(defn,((function() {
   ...
   var _result_ = (function(args121) {
var fun = args121[0];
var args = args121[1];
var body = args121[2];
                             return (plt.Kernel.setLastLoc("offset=6597 line=148 span=60 id=\"beginner-to-javascript.ss\"")   && function_dash_definition_dash__greaterthan_java_dash_string(fun,args,body,env,a_dash_pinfo)); });_result_.toWrittenString = function (cache) { return '<function:lambda>'; };_result_.procedureArity = (plt.types.Rational.makeInstance(3, 1));_result_.toDisplayedString = _result_.toWrittenString;return _result_;  })()),((function() {
   plt.Kernel.setLastLoc("offset=6662 line=149 span=85 id=\"beginner-to-javascript.ss\"");
   var _result_ = (function(args122) {
var id = args122[0];
var body = args122[1];
                             return (plt.Kernel.setLastLoc("offset=6685 line=150 span=61 id=\"beginner-to-javascript.ss\"")   && variable_dash_definition_dash__greaterthan_javascript_dash_strings(id,body,env,a_dash_pinfo)); });_result_.toWrittenString = function (cache) { return '<function:lambda>'; };_result_.procedureArity = (plt.types.Rational.makeInstance(2, 1));_result_.toDisplayedString = _result_.toWrittenString;return _result_;  })()),((function() {
...
var fields = args123[1];
                             return (plt.Kernel.setLastLoc("offset=6776 line=152 span=60 id=\"beginner-to-javascript.ss\"")   && struct_dash_definition_dash__greaterthan_javascript_dash_string(id,fields,env,a_dash_pinfo)); });_result_.toWrittenString = function (cache) { return '<function:lambda>'; };_result_.procedureArity = (plt.types.Rational.makeInstance(2, 1));_result_.toDisplayedString = _result_.toWrittenString;return _result_;  })()))); };
...
var id = args125[0];
                             return (plt.Kernel.setLastLoc("offset=7290 line=164 span=47 id=\"beginner-to-javascript.ss\"")   && identifier_dash__greaterthan_munged_dash_java_dash_identifier((plt.Kernel.setLastLoc("offset=7326 line=164 span=10 id=\"beginner-to-javascript.ss\"")   && stx_dash_e(id)))); });_result_.toWrittenString = function (cache) { return '<function:lambda>'; };_result_.procedureArity = (plt.types.Rational.makeInstance(1, 1));_result_.toDisplayedString = _result_.toWrittenString;return _result_;  })()), [args]));
...
return (plt.Kernel.setLastLoc("offset=20996 line=461 span=134 id=\"beginner-to-javascript.ss\"") && plt.Kernel.list([(plt.Kernel.setLastLoc("offset=21002 line=461 span=76 id=\"beginner-to-javascript.ss\"")   && plt.Kernel.cons((plt.Kernel.setLastLoc("offset=21008 line=461 span=20 id=\"beginner-to-javascript.ss\"")   && plt.Kernel.first(new_dash_string_plus_p)),(plt.Kernel.setLastLoc("offset=21065 line=462 span=12 id=\"beginner-to-javascript.ss\"")   && plt.Kernel.first(ss_plus_p)))),(plt.Kernel.setLastLoc("offset=21108 line=463 span=21 id=\"beginner-to-javascript.ss\"")   && plt.Kernel.second(new_dash_string_plus_p))]));
              })()); });_result_.toWrittenString = function (cache) { return '<function:lambda>'; };_result_.procedureArity = (plt.types.Rational.makeInstance(2, 1));_result_.toDisplayedString = _result_.toWrittenString;return _result_;  })()),(plt.Kernel.setLastLoc("offset=21152 line=464 span=20 id=\"beginner-to-javascript.ss\"") && plt.Kernel.list([plt.types.Empty.EMPTY,a_dash_pinfo])), [expressions])); })(plt.Kernel.identity)
...
var quote_dash_expression_dash__greaterthan_javascript_dash_string = function(expr) { return ((plt.Kernel.setLastLoc("offset=24078 line=536 span=21 id=\"beginner-to-javascript.ss\"")   && plt.Kernel.empty_question_((plt.Kernel.setLastLoc("offset=24086 line=536 span=12 id=\"beginner-to-javascript.ss\"")   && stx_dash_e(expr)))) ?
 ...
 (plt.Kernel.setLastLoc("offset=24166 line=540 span=198 id=\"beginner-to-javascript.ss\"") && plt.Kernel.string_dash_append([(plt.types.String.makeInstance("(plt.Kernel.list([")),(plt.Kernel.setLastLoc("offset=24222 line=541 span=115 id=\"beginner-to-javascript.ss\"")   && string_dash_join((plt.Kernel.setLastLoc("offset=24257 line=542 span=54 id=\"beginner-to-javascript.ss\"") && plt.Kernel.map((function() { var _result_ = (function(_args_) {
                    return quote_dash_expression_dash__greaterthan_javascript_dash_string(_args_[0]);});_result_.toWrittenString = function(cache) {return '<function:quote-expression->javascript-string>'; };_result_.toDisplayedString = _result_.toWrittenString; _result_.procedureArity = (plt.types.Rational.makeInstance(1, 1));return _result_; })(), [(plt.Kernel.setLastLoc("offset=24298 line=542 span=12 id=\"beginner-to-javascript.ss\"")   && stx_dash_e(expr))])),(plt.types.String.makeInstance(",")))),(plt.types.String.makeInstance("]))"))])) :
...
return ((plt.Kernel.setLastLoc("offset=27479 line=622 span=36 id=\"beginner-to-javascript.ss\"")   && binding_colon_constant_question_(operator_dash_binding)) ?
 (plt.Kernel.setLastLoc("offset=27526 line=623 span=414 id=\"beginner-to-javascript.ss\"") && plt.Kernel.list([(plt.Kernel.setLastLoc("offset=27532 line=623 span=377 id=\"beginner-to-javascript.ss\"") && plt.Kernel.string_dash_append([(plt.types.String.makeInstance("(")),(plt.Kernel.setLastLoc("offset=27551 line=623 span=73 id=\"beginner-to-javascript.ss\"") && plt.Kernel.format((plt.types.String.makeInstance("plt.Kernel.setLastLoc(~s)")), [(plt.Kernel.setLastLoc("offset=27587 line=623 span=36 id=\"beginner-to-javascript.ss\"")   && Loc_dash__greaterthan_string((plt.Kernel.setLastLoc("offset=27600 line=623 span=22 id=\"beginner-to-javascript.ss\"")   && stx_dash_loc(original_dash_stx))))])),(plt.types.String.makeInstance("  && plt.Kernel.apply(")),(plt.Kernel.setLastLoc("offset=27681 line=624 span=47 id=\"beginner-to-javascript.ss\"")   && binding_colon_constant_dash_java_dash_string(operator_dash_binding)),(plt.types.String.makeInstance(", ")),(plt.types.String.makeInstance("                       plt.Kernel.list([")),(plt.Kernel.setLastLoc("offset=27807 line=625 span=34 id=\"beginner-to-javascript.ss\"")   && string_dash_join(operand_dash_strings,(plt.types.String.makeInstance(", ")))),(plt.types.String.makeInstance("]),")),(plt.types.String.makeInstance("                       []))"))])),updated_dash_pinfo])) :
 ((plt.Kernel.setLastLoc("offset=27962 line=629 span=36 id=\"beginner-to-javascript.ss\"")   && binding_colon_function_question_(operator_dash_binding)) ?
 ((plt.Kernel.setLastLoc("offset=28028 line=631 span=83 id=\"beginner-to-javascript.ss\"") && plt.Kernel._lessthan_((plt.Kernel.setLastLoc("offset=28031 line=631 span=17 id=\"beginner-to-javascript.ss\"")   && plt.Kernel.length(operands)),(plt.Kernel.setLastLoc("offset=28065 line=632 span=45 id=\"beginner-to-javascript.ss\"")   && binding_colon_function_dash_min_dash_arity(operator_dash_binding)), [])) ?
 (plt.Kernel.setLastLoc("offset=28125 line=633 span=325 id=\"beginner-to-javascript.ss\"")   && plt.Kernel.syntax_dash_error((plt.Kernel.setLastLoc("offset=28139 line=633 span=270 id=\"beginner-to-javascript.ss\"") && plt.Kernel.format((plt.types.String.makeInstance("Too few arguments passed to ~s.  Expects at least ~a arguments, given ~a.")), [(plt.Kernel.setLastLoc("offset=28258 line=634 span=16 id=\"beginner-to-javascript.ss\"")   && stx_dash_e(operator)),(plt.Kernel.setLastLoc("offset=28310 line=635 span=45 id=\"beginner-to-javascript.ss\"")   && binding_colon_function_dash_min_dash_arity(operator_dash_binding)),(plt.Kernel.setLastLoc("offset=28391 line=636 span=17 id=\"beginner-to-javascript.ss\"")   && plt.Kernel.length(operands))])),original_dash_stx)) :
 ((plt.Kernel.setLastLoc("offset=28465 line=638 span=46 id=\"beginner-to-javascript.ss\"")   && binding_colon_function_dash_var_dash_arity_question_(operator_dash_binding)) ?
 ((plt.Kernel.setLastLoc("offset=28532 line=639 span=51 id=\"beginner-to-javascript.ss\"") && plt.Kernel._greaterthan_((plt.Kernel.setLastLoc("offset=28535 line=639 span=45 id=\"beginner-to-javascript.ss\"")   && binding_colon_function_dash_min_dash_arity(operator_dash_binding)),(plt.types.Rational.makeInstance(0, 1)), [])) ?
 (plt.Kernel.setLastLoc("offset=28604 line=640 span=708 id=\"beginner-to-javascript.ss\"") && plt.Kernel.list([(plt.Kernel.setLastLoc("offset=28632 line=641 span=644 id=\"beginner-to-javascript.ss\"") && plt.Kernel.string_dash_append([(plt.types.String.makeInstance("(")),(plt.Kernel.setLastLoc("offset=28651 line=641 span=73 id=\"beginner-to-javascript.ss\"") && plt.Kernel.format((plt.types.String.makeInstance("plt.Kernel.setLastLoc(~s)")), [(plt.Kernel.setLastLoc("offset=28687 line=641 span=36 id=\"beginner-to-javascript.ss\"")   && Loc_dash__greaterthan_string((plt.Kernel.setLastLoc("offset=28700 line=641 span=22 id=\"beginner-to-javascript.ss\"")   && stx_dash_loc(original_dash_stx))))])),(plt.types.String.makeInstance(" && ")),(plt.Kernel.setLastLoc("offset=28804 line=643 span=47 id=\"beginner-to-javascript.ss\"")   && binding_colon_function_dash_java_dash_string(operator_dash_binding)),(plt.types.String.makeInstance("(")),(plt.Kernel.setLastLoc("offset=28928 line=645 span=86 id=\"beginner-to-javascript.ss\"")   && string_dash_join((plt.Kernel.setLastLoc("offset=28941 line=645 span=68 id=\"beginner-to-javascript.ss\"")   && take(operand_dash_strings,(plt.Kernel.setLastLoc("offset=28963 line=645 span=45 id=\"beginner-to-javascript.ss\"")   && binding_colon_function_dash_min_dash_arity(operator_dash_binding)))),(plt.types.String.makeInstance(",")))),(plt.types.String.makeInstance(", [")),(plt.Kernel.setLastLoc("offset=29093 line=647 span=140 id=\"beginner-to-javascript.ss\"")   && string_dash_join((plt.Kernel.setLastLoc("offset=29106 line=647 span=73 id=\"beginner-to-javascript.ss\"")   && list_dash_tail(operand_dash_strings,(plt.Kernel.setLastLoc("offset=29133 line=647 span=45 id=\"beginner-to-javascript.ss\"")   && binding_colon_function_dash_min_dash_arity(operator_dash_binding)))),(plt.types.String.makeInstance(",")))),(plt.types.String.makeInstance("]))"))])),updated_dash_pinfo])) :
 (plt.types.Logic.TRUE ?
 (plt.Kernel.setLastLoc("offset=29359 line=652 span=437 id=\"beginner-to-javascript.ss\"") && plt.Kernel.list([(plt.Kernel.setLastLoc("offset=29386 line=653 span=374 id=\"beginner-to-javascript.ss\"") && plt.Kernel.string_dash_append([(plt.types.String.makeInstance("(")),(plt.Kernel.setLastLoc("offset=29405 line=653 span=73 id=\"beginner-to-javascript.ss\"") && plt.Kernel.format((plt.types.String.makeInstance("plt.Kernel.setLastLoc(~s)")), [(plt.Kernel.setLastLoc("offset=29441 line=653 span=36 id=\"beginner-to-javascript.ss\"")   && Loc_dash__greaterthan_string((plt.Kernel.setLastLoc("offset=29454 line=653 span=22 id=\"beginner-to-javascript.ss\"")   && stx_dash_loc(original_dash_stx))))])),(plt.types.String.makeInstance(" && ")),(plt.Kernel.setLastLoc("offset=29558 line=655 span=47 id=\"beginner-to-javascript.ss\"")   && binding_colon_function_dash_java_dash_string(operator_dash_binding)),(plt.types.String.makeInstance("([")),(plt.Kernel.setLastLoc("offset=29684 line=657 span=33 id=\"beginner-to-javascript.ss\"")   && string_dash_join(operand_dash_strings,(plt.types.String.makeInstance(",")))),(plt.types.String.makeInstance("]))"))])),updated_dash_pinfo])) :
 (plt.Kernel.setLastLoc("offset=28525 line=639 span=1273 id=\"beginner-to-javascript.ss\"")   && plt.Kernel.error((plt.types.Symbol.makeInstance("cond")),(plt.types.String.makeInstance("cond: fell out of cond around \"offset=28525 line=639 span=1273 id=\\\"beginner-to-javascript.ss\\\"\"")))))) :
 (plt.types.Logic.TRUE ?
 ((plt.Kernel.setLastLoc("offset=29853 line=662 span=86 id=\"beginner-to-javascript.ss\"") && plt.Kernel._greaterthan_((plt.Kernel.setLastLoc("offset=29856 line=662 span=17 id=\"beginner-to-javascript.ss\"")   && plt.Kernel.length(operands)),(plt.Kernel.setLastLoc("offset=29893 line=663 span=45 id=\"beginner-to-javascript.ss\"")   && binding_colon_function_dash_min_dash_arity(operator_dash_binding)), [])) ?
 (plt.Kernel.setLastLoc("offset=29956 line=664 span=337 id=\"beginner-to-javascript.ss\"")   && plt.Kernel.syntax_dash_error((plt.Kernel.setLastLoc("offset=29970 line=664 span=279 id=\"beginner-to-javascript.ss\"") && plt.Kernel.format((plt.types.String.makeInstance("Too many arguments passed to ~s.  Expects at most ~a arguments, given ~a.")), [(plt.Kernel.setLastLoc("offset=30092 line=665 span=16 id=\"beginner-to-javascript.ss\"")   && stx_dash_e(operator)),(plt.Kernel.setLastLoc("offset=30147 line=666 span=45 id=\"beginner-to-javascript.ss\"")   && binding_colon_function_dash_min_dash_arity(operator_dash_binding)),(plt.Kernel.setLastLoc("offset=30231 line=667 span=17 id=\"beginner-to-javascript.ss\"")   && plt.Kernel.length(operands))])),original_dash_stx)) :
 (plt.types.Logic.TRUE ?
 (plt.Kernel.setLastLoc("offset=30332 line=670 span=377 id=\"beginner-to-javascript.ss\"") && plt.Kernel.list([(plt.Kernel.setLastLoc("offset=30356 line=671 span=321 id=\"beginner-to-javascript.ss\"") && plt.Kernel.string_dash_append([(plt.types.String.makeInstance("(")),(plt.Kernel.setLastLoc("offset=30407 line=672 span=73 id=\"beginner-to-javascript.ss\"") && plt.Kernel.format((plt.types.String.makeInstance("plt.Kernel.setLastLoc(~s)")), [(plt.Kernel.setLastLoc("offset=30443 line=672 span=36 id=\"beginner-to-javascript.ss\"")   && Loc_dash__greaterthan_string((plt.Kernel.setLastLoc("offset=30456 line=672 span=22 id=\"beginner-to-javascript.ss\"")   && stx_dash_loc(original_dash_stx))))])),(plt.types.String.makeInstance("   && ")),(plt.Kernel.setLastLoc("offset=30554 line=674 span=47 id=\"beginner-to-javascript.ss\"")   && binding_colon_function_dash_java_dash_string(operator_dash_binding)),(plt.types.String.makeInstance("(")),(plt.Kernel.setLastLoc("offset=30638 line=675 span=33 id=\"beginner-to-javascript.ss\"")   && string_dash_join(operand_dash_strings,(plt.types.String.makeInstance(",")))),(plt.types.String.makeInstance("))"))])),updated_dash_pinfo])) :
 (plt.Kernel.setLastLoc("offset=29831 line=661 span=880 id=\"beginner-to-javascript.ss\"")   && plt.Kernel.error((plt.types.Symbol.makeInstance("cond")),(plt.types.String.makeInstance("cond: fell out of cond around \"offset=29831 line=661 span=880 id=\\\"beginner-to-javascript.ss\\\"\"")))))) :
 (plt.Kernel.setLastLoc("offset=28009 line=630 span=2704 id=\"beginner-to-javascript.ss\"")   && plt.Kernel.error((plt.types.Symbol.makeInstance("cond")),(plt.types.String.makeInstance("cond: fell out of cond around \"offset=28009 line=630 span=2704 id=\\\"beginner-to-javascript.ss\\\"\""))))))) :
 (plt.Kernel.setLastLoc("offset=27453 line=620 span=3262 id=\"beginner-to-javascript.ss\"")   && plt.Kernel.error((plt.types.Symbol.makeInstance("cond")),(plt.types.String.makeInstance("cond: fell out of cond around \"offset=27453 line=620 span=3262 id=\\\"beginner-to-javascript.ss\\\"\""))))));
              })()) :
 (plt.types.Logic.TRUE ?
 ((function() { 
...
expression_dash_strings_plus_pinfo = (plt.Kernel.setLastLoc("offset=30821 line=681 span=166 id=\"beginner-to-javascript.ss\"")   && expressions_dash__greaterthan_javascript_dash_strings((plt.Kernel.setLastLoc("offset=30854 line=681 span=24 id=\"beginner-to-javascript.ss\"")   && plt.Kernel.cons(operator,operands)),env,a_dash_pinfo));
operator_dash_string = (plt.Kernel.setLastLoc("offset=31026 line=684 span=40 id=\"beginner-to-javascript.ss\"")   && plt.Kernel.first((plt.Kernel.setLastLoc("offset=31033 line=684 span=32 id=\"beginner-to-javascript.ss\"")   && plt.Kernel.first(expression_dash_strings_plus_pinfo))));
operand_dash_strings = (plt.Kernel.setLastLoc("offset=31105 line=685 span=39 id=\"beginner-to-javascript.ss\"")   && plt.Kernel.rest((plt.Kernel.setLastLoc("offset=31111 line=685 span=32 id=\"beginner-to-javascript.ss\"")   && plt.Kernel.first(expression_dash_strings_plus_pinfo))));
updated_dash_pinfo = (plt.Kernel.setLastLoc("offset=31181 line=686 span=33 id=\"beginner-to-javascript.ss\"")   && plt.Kernel.second(expression_dash_strings_plus_pinfo)); })(plt.Kernel.identity)
return (plt.Kernel.setLastLoc("offset=31224 line=687 span=378 id=\"beginner-to-javascript.ss\"") && plt.Kernel.list([(plt.Kernel.setLastLoc("offset=31238 line=688 span=341 id=\"beginner-to-javascript.ss\"") && plt.Kernel.string_dash_append([(plt.types.String.makeInstance("(")),(plt.Kernel.setLastLoc("offset=31257 line=688 span=73 id=\"beginner-to-javascript.ss\"") && plt.Kernel.format((plt.types.String.makeInstance("plt.Kernel.setLastLoc(~s)")), [(plt.Kernel.setLastLoc("offset=31293 line=688 span=36 id=\"beginner-to-javascript.ss\"")   && Loc_dash__greaterthan_string((plt.Kernel.setLastLoc("offset=31306 line=688 span=22 id=\"beginner-to-javascript.ss\"")   && stx_dash_loc(original_dash_stx))))])),(plt.types.String.makeInstance(" && ")),(plt.types.String.makeInstance("plt.Kernel.apply(")),operator_dash_string,(plt.types.String.makeInstance(", ")),(plt.types.String.makeInstance("                   plt.Kernel.list([")),(plt.Kernel.setLastLoc("offset=31488 line=691 span=34 id=\"beginner-to-javascript.ss\"")   && string_dash_join(operand_dash_strings,(plt.types.String.makeInstance(", ")))),(plt.types.String.makeInstance("]), ")),(plt.types.String.makeInstance("                   []))"))])),updated_dash_pinfo]));
              })()) :
 (plt.Kernel.setLastLoc("offset=26783 line=606 span=4822 id=\"beginner-to-javascript.ss\"")   && plt.Kernel.error((plt.types.Symbol.makeInstance("cond")),(plt.types.String.makeInstance("cond: fell out of cond around \"offset=26783 line=606 span=4822 id=\\\"beginner-to-javascript.ss\\\"\""))))))); };
var identifier_dash_expression_dash__greaterthan_javascript_dash_string = function(an_dash_id, an_dash_env) { return ((plt.Kernel.setLastLoc("offset=31837 line=702 span=42 id=\"beginner-to-javascript.ss\"")   && plt.Kernel.not((plt.Kernel.setLastLoc("offset=31842 line=702 span=36 id=\"beginner-to-javascript.ss\"")   && env_dash_contains_question_(an_dash_env,(plt.Kernel.setLastLoc("offset=31864 line=702 span=13 id=\"beginner-to-javascript.ss\"")   && stx_dash_e(an_dash_id)))))) ?
 (plt.Kernel.setLastLoc("offset=31885 line=703 span=131 id=\"beginner-to-javascript.ss\"")   && plt.Kernel.syntax_dash_error((plt.Kernel.setLastLoc("offset=31899 line=703 span=91 id=\"beginner-to-javascript.ss\"") && plt.Kernel.format((plt.types.String.makeInstance("name ~s is not defined, not a parameter, and not a primitive name.")), [(plt.Kernel.setLastLoc("offset=31976 line=703 span=13 id=\"beginner-to-javascript.ss\"")   && stx_dash_e(an_dash_id))])),an_dash_id)) :
 (plt.types.Logic.TRUE ?
 ((function() { 

var binding; 
(function (toplevel_dash_expression_dash_show156) { 
binding = (plt.Kernel.setLastLoc("offset=32062 line=706 span=33 id=\"beginner-to-javascript.ss\"")   && env_dash_lookup(an_dash_env,(plt.Kernel.setLastLoc("offset=32081 line=706 span=13 id=\"beginner-to-javascript.ss\"")   && stx_dash_e(an_dash_id)))); })(plt.Kernel.identity)
return ((plt.Kernel.setLastLoc("offset=32121 line=708 span=27 id=\"beginner-to-javascript.ss\"")   && binding_colon_constant_question_(binding)) ?
 (plt.Kernel.setLastLoc("offset=32159 line=709 span=38 id=\"beginner-to-javascript.ss\"")   && binding_colon_constant_dash_java_dash_string(binding)) :
 ((plt.Kernel.setLastLoc("offset=32209 line=710 span=27 id=\"beginner-to-javascript.ss\"")   && binding_colon_function_question_(binding)) ?
 ((plt.Kernel.setLastLoc("offset=32266 line=712 span=37 id=\"beginner-to-javascript.ss\"")   && binding_colon_function_dash_var_dash_arity_question_(binding)) ?
 (plt.Kernel.setLastLoc("offset=32317 line=713 span=876 id=\"beginner-to-javascript.ss\"") && plt.Kernel.string_dash_append([(plt.types.String.makeInstance("((function() { var _result_ = (function(_args_) {\n                    return ")),(plt.Kernel.setLastLoc("offset=32412 line=714 span=38 id=\"beginner-to-javascript.ss\"")   && binding_colon_function_dash_java_dash_string(binding)),(plt.types.String.makeInstance("    .apply(null, _args_.slice(0, ")),(plt.Kernel.setLastLoc("offset=32516 line=715 span=53 id=\"beginner-to-javascript.ss\"")   && plt.Kernel.number_dash__greaterthan_string((plt.Kernel.setLastLoc("offset=32532 line=715 span=36 id=\"beginner-to-javascript.ss\"")   && binding_colon_function_dash_min_dash_arity(binding)))),(plt.types.String.makeInstance("                        ).concat([_args_.slice(")),(plt.Kernel.setLastLoc("offset=32649 line=716 span=53 id=\"beginner-to-javascript.ss\"")   && plt.Kernel.number_dash__greaterthan_string((plt.Kernel.setLastLoc("offset=32665 line=716 span=36 id=\"beginner-to-javascript.ss\"")   && binding_colon_function_dash_min_dash_arity(binding)))),(plt.types.String.makeInstance(")])); });")),(plt.types.String.makeInstance("_result_.toWrittenString = function(cache) {return '<function:")),(plt.Kernel.setLastLoc("offset=32808 line=717 span=37 id=\"beginner-to-javascript.ss\"")   && plt.Kernel.symbol_dash__greaterthan_string((plt.Kernel.setLastLoc("offset=32824 line=717 span=20 id=\"beginner-to-javascript.ss\"")   && binding_dash_id(binding)))),(plt.types.String.makeInstance(">'; };")),(plt.types.String.makeInstance("_result_.toDisplayedString = _result_.toWrittenString;")),(plt.types.String.makeInstance("_result_.procedureArity = plt.Kernel.list([plt.types.Symbol.makeInstance('at-least'), ")),(plt.Kernel.setLastLoc("offset=33059 line=719 span=73 id=\"beginner-to-javascript.ss\"")   && rational_dash_number_dash__greaterthan_javascript_dash_string((plt.Kernel.setLastLoc("offset=33095 line=719 span=36 id=\"beginner-to-javascript.ss\"")   && binding_colon_function_dash_min_dash_arity(binding)))),(plt.types.String.makeInstance("]);")),(plt.types.String.makeInstance("return _result_; })())"))])) :
 (plt.types.Logic.TRUE ?
 (plt.Kernel.setLastLoc("offset=33226 line=722 span=906 id=\"beginner-to-javascript.ss\"") && plt.Kernel.string_dash_append([(plt.types.String.makeInstance("(function() { var _result_ = (function(_args_) {\n                    return ")),(plt.Kernel.setLastLoc("offset=33320 line=723 span=38 id=\"beginner-to-javascript.ss\"")   && binding_colon_function_dash_java_dash_string(binding)),(plt.types.String.makeInstance("(")),(plt.Kernel.setLastLoc("offset=33419 line=725 span=265 id=\"beginner-to-javascript.ss\"")   && string_dash_join((plt.Kernel.setLastLoc("offset=33432 line=725 span=205 id=\"beginner-to-javascript.ss\"") && plt.Kernel.map(((function() {
   plt.Kernel.setLastLoc("offset=33437 line=725 span=108 id=\"beginner-to-javascript.ss\"");
   var _result_ = (function(args157) {
var i = args157[0];
                             return (plt.Kernel.setLastLoc("offset=33497 line=726 span=47 id=\"beginner-to-javascript.ss\"") && plt.Kernel.string_dash_append([(plt.types.String.makeInstance("_args_[")),(plt.Kernel.setLastLoc("offset=33522 line=726 span=18 id=\"beginner-to-javascript.ss\"")   && plt.Kernel.number_dash__greaterthan_string(i)),(plt.types.String.makeInstance("]"))])); });_result_.toWrittenString = function (cache) { return '<function:lambda>'; };_result_.procedureArity = (plt.types.Rational.makeInstance(1, 1));_result_.toDisplayedString = _result_.toWrittenString;return _result_;  })()), [(plt.Kernel.setLastLoc("offset=33592 line=727 span=44 id=\"beginner-to-javascript.ss\"")   && range((plt.Kernel.setLastLoc("offset=33599 line=727 span=36 id=\"beginner-to-javascript.ss\"")   && binding_colon_function_dash_min_dash_arity(binding))))])),(plt.types.String.makeInstance(", ")))),(plt.types.String.makeInstance(");});")),(plt.types.String.makeInstance("_result_.toWrittenString = function(cache) {return '<function:")),(plt.Kernel.setLastLoc("offset=33813 line=730 span=37 id=\"beginner-to-javascript.ss\"")   && plt.Kernel.symbol_dash__greaterthan_string((plt.Kernel.setLastLoc("offset=33829 line=730 span=20 id=\"beginner-to-javascript.ss\"")   && binding_dash_id(binding)))),(plt.types.String.makeInstance(">'; };")),(plt.types.String.makeInstance("_result_.toDisplayedString = _result_.toWrittenString; ")),(plt.types.String.makeInstance("_result_.procedureArity = ")),(plt.Kernel.setLastLoc("offset=34002 line=732 span=73 id=\"beginner-to-javascript.ss\"")   && rational_dash_number_dash__greaterthan_javascript_dash_string((plt.Kernel.setLastLoc("offset=34038 line=732 span=36 id=\"beginner-to-javascript.ss\"")   && binding_colon_function_dash_min_dash_arity(binding)))),(plt.types.String.makeInstance(";")),(plt.types.String.makeInstance("return _result_; })()"))])) :
 (plt.Kernel.setLastLoc("offset=32247 line=711 span=1887 id=\"beginner-to-javascript.ss\"")   && plt.Kernel.error((plt.types.Symbol.makeInstance("cond")),(plt.types.String.makeInstance("cond: fell out of cond around \"offset=32247 line=711 span=1887 id=\\\"beginner-to-javascript.ss\\\"\"")))))) :
 (plt.Kernel.setLastLoc("offset=32105 line=707 span=2031 id=\"beginner-to-javascript.ss\"")   && plt.Kernel.error((plt.types.Symbol.makeInstance("cond")),(plt.types.String.makeInstance("cond: fell out of cond around \"offset=32105 line=707 span=2031 id=\\\"beginner-to-javascript.ss\\\"\""))))));
              })()) :
 (plt.Kernel.setLastLoc("offset=31826 line=701 span=2313 id=\"beginner-to-javascript.ss\"")   && plt.Kernel.error((plt.types.Symbol.makeInstance("cond")),(plt.types.String.makeInstance("cond: fell out of cond around \"offset=31826 line=701 span=2313 id=\\\"beginner-to-javascript.ss\\\"\"")))))); };
...
var loop = function(i, elts) { return ((plt.Kernel.setLastLoc("offset=34510 line=745 span=13 id=\"beginner-to-javascript.ss\"")   && plt.Kernel.empty_question_(elts)) ?
 plt.types.Empty.EMPTY :
 (plt.types.Logic.TRUE ?
 (plt.Kernel.setLastLoc("offset=34611 line=748 span=84 id=\"beginner-to-javascript.ss\"")   && plt.Kernel.cons((plt.Kernel.setLastLoc("offset=34617 line=748 span=18 id=\"beginner-to-javascript.ss\"")  && plt.Kernel.apply(f,                        plt.Kernel.list([(plt.Kernel.setLastLoc("offset=34620 line=748 span=12 id=\"beginner-to-javascript.ss\"")   && plt.Kernel.first(elts)), i]),                       [])),(plt.Kernel.setLastLoc("offset=34667 line=749 span=27 id=\"beginner-to-javascript.ss\"")   && loop((plt.Kernel.setLastLoc("offset=34673 line=749 span=8 id=\"beginner-to-javascript.ss\"")   && plt.Kernel.add1(i)),(plt.Kernel.setLastLoc("offset=34682 line=749 span=11 id=\"beginner-to-javascript.ss\"")   && plt.Kernel.rest(elts)))))) :
 (plt.Kernel.setLastLoc("offset=34479 line=744 span=218 id=\"beginner-to-javascript.ss\"")   && plt.Kernel.error((plt.types.Symbol.makeInstance("cond")),(plt.types.String.makeInstance("cond: fell out of cond around \"offset=34479 line=744 span=218 id=\\\"beginner-to-javascript.ss\\\"\"")))))); };
(function (toplevel_dash_expression_dash_show159) { 
 })(plt.Kernel.identity)
return (plt.Kernel.setLastLoc("offset=34714 line=750 span=13 id=\"beginner-to-javascript.ss\"")   && loop((plt.types.Rational.makeInstance(0, 1)),elts));
              })()); };
var munged_dash_arg_dash_ids; 
var new_dash_env; 
...
munged_dash_arg_dash_ids = (plt.Kernel.setLastLoc("offset=34786 line=753 span=89 id=\"beginner-to-javascript.ss\"") && plt.Kernel.map(((function() {
   plt.Kernel.setLastLoc("offset=34791 line=753 span=61 id=\"beginner-to-javascript.ss\"");
   var _result_ = (function(args160) {
var id = args160[0];
                             return (plt.Kernel.setLastLoc("offset=34804 line=753 span=47 id=\"beginner-to-javascript.ss\"")   && identifier_dash__greaterthan_munged_dash_java_dash_identifier((plt.Kernel.setLastLoc("offset=34840 line=753 span=10 id=\"beginner-to-javascript.ss\"")   && stx_dash_e(id)))); });_result_.toWrittenString = function (cache) { return '<function:lambda>'; };_result_.procedureArity = (plt.types.Rational.makeInstance(1, 1));_result_.toDisplayedString = _result_.toWrittenString;return _result_;  })()), [args]));
new_dash_env = (plt.Kernel.setLastLoc("offset=34926 line=757 span=401 id=\"beginner-to-javascript.ss\"") && plt.Kernel.foldl(((function() {
   plt.Kernel.setLastLoc("offset=34933 line=757 span=346 id=\"beginner-to-javascript.ss\"");
   var _result_ = (function(args161) {
var arg_dash_id = args161[0];
var env = args161[1];
                             return (plt.Kernel.setLastLoc("offset=34976 line=758 span=302 id=\"beginner-to-javascript.ss\"")   && env_dash_extend(env,(plt.Kernel.setLastLoc("offset=35026 line=759 span=251 id=\"beginner-to-javascript.ss\"")   && make_dash_binding_colon_constant((plt.Kernel.setLastLoc("offset=35084 line=760 span=14 id=\"beginner-to-javascript.ss\"")   && stx_dash_e(arg_dash_id)),(plt.Kernel.setLastLoc("offset=35133 line=761 span=103 id=\"beginner-to-javascript.ss\"")   && plt.Kernel.symbol_dash__greaterthan_string((plt.Kernel.setLastLoc("offset=35184 line=762 span=51 id=\"beginner-to-javascript.ss\"")   && identifier_dash__greaterthan_munged_dash_java_dash_identifier((plt.Kernel.setLastLoc("offset=35220 line=762 span=14 id=\"beginner-to-javascript.ss\"")   && stx_dash_e(arg_dash_id)))))),plt.types.Empty.EMPTY)))); });_result_.toWrittenString = function (cache) { return '<function:lambda>'; };_result_.procedureArity = (plt.types.Rational.makeInstance(2, 1));_result_.toDisplayedString = _result_.toWrittenString;return _result_;  })()),env, [args]));
pinfo_plus_args_dash_sym = (plt.Kernel.setLastLoc("offset=35385 line=768 span=28 id=\"beginner-to-javascript.ss\"")   && pinfo_dash_gensym(a_dash_pinfo,(plt.types.Symbol.makeInstance("args"))));
a_dash_pinfo_dash_2 = (plt.Kernel.setLastLoc("offset=35464 line=770 span=22 id=\"beginner-to-javascript.ss\"")   && plt.Kernel.first(pinfo_plus_args_dash_sym));
args_dash_sym = (plt.Kernel.setLastLoc("offset=35515 line=771 span=23 id=\"beginner-to-javascript.ss\"")   && plt.Kernel.second(pinfo_plus_args_dash_sym));
body_dash_string_plus_p = (plt.Kernel.setLastLoc("offset=35595 line=774 span=54 id=\"beginner-to-javascript.ss\"")   && expression_dash__greaterthan_javascript_dash_string(body,new_dash_env,a_dash_pinfo_dash_2));
body_dash_string = (plt.Kernel.setLastLoc("offset=35681 line=775 span=21 id=\"beginner-to-javascript.ss\"")   && plt.Kernel.first(body_dash_string_plus_p));
updated_dash_pinfo = (plt.Kernel.setLastLoc("offset=35736 line=776 span=22 id=\"beginner-to-javascript.ss\"")   && plt.Kernel.second(body_dash_string_plus_p)); })(plt.Kernel.identity)
return (function(){(plt.Kernel.setLastLoc("offset=35778 line=778 span=35 id=\"beginner-to-javascript.ss\"")   && check_dash_duplicate_dash_identifiers_bang_(args));
return (plt.Kernel.setLastLoc("offset=35820 line=779 span=1221 id=\"beginner-to-javascript.ss\"") && plt.Kernel.list([(plt.Kernel.setLastLoc("offset=35833 line=780 span=1186 id=\"beginner-to-javascript.ss\"") && plt.Kernel.string_dash_append([(plt.types.String.makeInstance("((function() {\n")),(plt.types.String.makeInstance("   plt.Kernel.setLastLoc(")),(plt.Kernel.setLastLoc("offset=35917 line=781 span=50 id=\"beginner-to-javascript.ss\"") && plt.Kernel.format((plt.types.String.makeInstance("~s")), [(plt.Kernel.setLastLoc("offset=35930 line=781 span=36 id=\"beginner-to-javascript.ss\"")   && Loc_dash__greaterthan_string((plt.Kernel.setLastLoc("offset=35943 line=781 span=22 id=\"beginner-to-javascript.ss\"")   && stx_dash_loc(original_dash_stx))))])),(plt.types.String.makeInstance(");\n")),(plt.types.String.makeInstance("   var _result_ = (function(")),(plt.Kernel.setLastLoc("offset=36028 line=782 span=25 id=\"beginner-to-javascript.ss\"")   && plt.Kernel.symbol_dash__greaterthan_string(args_dash_sym)),(plt.types.String.makeInstance(") {\n")),(plt.Kernel.setLastLoc("offset=36084 line=783 span=518 id=\"beginner-to-javascript.ss\"")   && string_dash_join((plt.Kernel.setLastLoc("offset=36097 line=783 span=464 id=\"beginner-to-javascript.ss\"")   && mapi(((function() {
   plt.Kernel.setLastLoc("offset=36103 line=783 span=401 id=\"beginner-to-javascript.ss\"");
   var _result_ = (function(args162) {
var arg_dash_id = args162[0];
var i = args162[1];
                             return (plt.Kernel.setLastLoc("offset=36165 line=784 span=338 id=\"beginner-to-javascript.ss\"") && plt.Kernel.string_dash_append([(plt.types.String.makeInstance("var ")),(plt.Kernel.setLastLoc("offset=36245 line=785 span=23 id=\"beginner-to-javascript.ss\"")   && plt.Kernel.symbol_dash__greaterthan_string(arg_dash_id)),(plt.types.String.makeInstance(" = ")),(plt.Kernel.setLastLoc("offset=36391 line=787 span=25 id=\"beginner-to-javascript.ss\"")   && plt.Kernel.symbol_dash__greaterthan_string(args_dash_sym)),(plt.types.String.makeInstance("[")),(plt.Kernel.setLastLoc("offset=36479 line=788 span=18 id=\"beginner-to-javascript.ss\"")   && plt.Kernel.number_dash__greaterthan_string(i)),(plt.types.String.makeInstance("];"))])); });_result_.toWrittenString = function (cache) { return '<function:lambda>'; };_result_.procedureArity = (plt.types.Rational.makeInstance(2, 1));_result_.toDisplayedString = _result_.toWrittenString;return _result_;  })()),munged_dash_arg_dash_ids)),(plt.types.String.makeInstance("\n")))),(plt.types.String.makeInstance("\n                             return ")),body_dash_string,(plt.types.String.makeInstance("; });")),(plt.types.String.makeInstance("_result_.toWrittenString = function (cache) { return '<function:lambda>'; };")),(plt.types.String.makeInstance("_result_.procedureArity = ")),(plt.Kernel.setLastLoc("offset=36837 line=794 span=50 id=\"beginner-to-javascript.ss\"")   && rational_dash_number_dash__greaterthan_javascript_dash_string((plt.Kernel.setLastLoc("offset=36873 line=794 span=13 id=\"beginner-to-javascript.ss\"")   && plt.Kernel.length(args)))),(plt.types.String.makeInstance(";")),(plt.types.String.makeInstance("_result_.toDisplayedString = _result_.toWrittenString;")),(plt.types.String.makeInstance("return _result_;  })())"))])),updated_dash_pinfo]));})();
              })()); };
var floating_dash_number_dash__greaterthan_javascript_dash_string = function(a_dash_num) { return (plt.Kernel.setLastLoc("offset=37157 line=803 span=418 id=\"beginner-to-javascript.ss\"") && plt.Kernel.string_dash_append([(plt.types.String.makeInstance("(plt.types.FloatPoint.makeInstance(")),((plt.Kernel.setLastLoc("offset=37253 line=805 span=19 id=\"beginner-to-javascript.ss\"")   && plt.Kernel.eqv_question_(a_dash_num,(plt.types.FloatPoint.makeInstance(Number.POSITIVE_INFINITY)))) ?
 (plt.types.String.makeInstance("Number.POSITIVE_INFINITY")) :
 ((plt.Kernel.setLastLoc("offset=37341 line=807 span=19 id=\"beginner-to-javascript.ss\"")   && plt.Kernel.eqv_question_(a_dash_num,(plt.types.FloatPoint.makeInstance(Number.NEGATIVE_INFINITY)))) ?
 (plt.types.String.makeInstance("Number.NEGATIVE_INFINITY")) :
 ((plt.Kernel.setLastLoc("offset=37429 line=809 span=19 id=\"beginner-to-javascript.ss\"")   && plt.Kernel.eqv_question_(a_dash_num,(plt.types.FloatPoint.makeInstance(Number.NaN)))) ?
 (plt.types.String.makeInstance("Number.NaN")) :
 (plt.types.Logic.TRUE ?
 (plt.Kernel.setLastLoc("offset=37528 line=812 span=22 id=\"beginner-to-javascript.ss\"")   && plt.Kernel.number_dash__greaterthan_string(a_dash_num)) :
 (plt.Kernel.setLastLoc("offset=37227 line=804 span=325 id=\"beginner-to-javascript.ss\"")   && plt.Kernel.error((plt.types.Symbol.makeInstance("cond")),(plt.types.String.makeInstance("cond: fell out of cond around \"offset=37227 line=804 span=325 id=\\\"beginner-to-javascript.ss\\\"\"")))))))),(plt.types.String.makeInstance("))"))])); };
var rational_dash_number_dash__greaterthan_javascript_dash_string = function(a_dash_num) { return (plt.Kernel.setLastLoc("offset=37688 line=818 span=201 id=\"beginner-to-javascript.ss\"") && plt.Kernel.string_dash_append([(plt.types.String.makeInstance("(plt.types.Rational.makeInstance(")),(plt.Kernel.setLastLoc("offset=37756 line=819 span=34 id=\"beginner-to-javascript.ss\"")   && plt.Kernel.number_dash__greaterthan_string((plt.Kernel.setLastLoc("offset=37772 line=819 span=17 id=\"beginner-to-javascript.ss\"")   && plt.Kernel.numerator(a_dash_num)))),(plt.types.String.makeInstance(", ")),(plt.Kernel.setLastLoc("offset=37830 line=821 span=36 id=\"beginner-to-javascript.ss\"")   && plt.Kernel.number_dash__greaterthan_string((plt.Kernel.setLastLoc("offset=37846 line=821 span=19 id=\"beginner-to-javascript.ss\"")   && plt.Kernel.denominator(a_dash_num)))),(plt.types.String.makeInstance("))"))])); };
var number_dash__greaterthan_javascript_dash_string = function(a_dash_num, original_dash_stx) { return ((plt.Kernel.setLastLoc("offset=38146 line=834 span=17 id=\"beginner-to-javascript.ss\"")   && plt.Kernel.rational_question_(a_dash_num)) ?
 (plt.Kernel.setLastLoc("offset=38169 line=835 span=42 id=\"beginner-to-javascript.ss\"")   && rational_dash_number_dash__greaterthan_javascript_dash_string(a_dash_num)) :
 ((plt.Kernel.setLastLoc("offset=38223 line=837 span=13 id=\"beginner-to-javascript.ss\"")   && plt.Kernel.real_question_(a_dash_num)) ?
 (plt.Kernel.setLastLoc("offset=38242 line=838 span=42 id=\"beginner-to-javascript.ss\"")   && floating_dash_number_dash__greaterthan_javascript_dash_string(a_dash_num)) :
 ((plt.Kernel.setLastLoc("offset=38296 line=840 span=16 id=\"beginner-to-javascript.ss\"")   && plt.Kernel.complex_question_(a_dash_num)) ?
 (plt.Kernel.setLastLoc("offset=38318 line=841 span=258 id=\"beginner-to-javascript.ss\"") && plt.Kernel.string_dash_append([(plt.types.String.makeInstance("(plt.types.Complex.makeInstance(")),(plt.Kernel.setLastLoc("offset=38388 line=842 span=58 id=\"beginner-to-javascript.ss\"")   && number_dash__greaterthan_javascript_dash_string((plt.Kernel.setLastLoc("offset=38415 line=842 span=17 id=\"beginner-to-javascript.ss\"")   && plt.Kernel.real_dash_part(a_dash_num)),original_dash_stx)),(plt.types.String.makeInstance(", ")),(plt.Kernel.setLastLoc("offset=38492 line=844 span=58 id=\"beginner-to-javascript.ss\"")   && number_dash__greaterthan_javascript_dash_string((plt.Kernel.setLastLoc("offset=38519 line=844 span=17 id=\"beginner-to-javascript.ss\"")   && plt.Kernel.imag_dash_part(a_dash_num)),original_dash_stx)),(plt.types.String.makeInstance("))"))])) :
 (plt.types.Logic.TRUE ?
 (plt.Kernel.setLastLoc("offset=38598 line=848 span=95 id=\"beginner-to-javascript.ss\"")   && plt.Kernel.syntax_dash_error((plt.Kernel.setLastLoc("offset=38612 line=848 span=48 id=\"beginner-to-javascript.ss\"") && plt.Kernel.format((plt.types.String.makeInstance("Don't know how to handle ~s yet")), [a_dash_num])),original_dash_stx)) :
 (plt.Kernel.setLastLoc("offset=37996 line=828 span=699 id=\"beginner-to-javascript.ss\"")   && plt.Kernel.error((plt.types.Symbol.makeInstance("cond")),(plt.types.String.makeInstance("cond: fell out of cond around \"offset=37996 line=828 span=699 id=\\\"beginner-to-javascript.ss\\\"\"")))))))); };
var char_dash__greaterthan_javascript_dash_string = function(a_dash_char) { return (plt.Kernel.setLastLoc("offset=38786 line=855 span=147 id=\"beginner-to-javascript.ss\"") && plt.Kernel.string_dash_append([(plt.types.String.makeInstance("(plt.types.Char.makeInstance(String.fromCharCode(")),(plt.Kernel.setLastLoc("offset=38870 line=856 span=39 id=\"beginner-to-javascript.ss\"")   && plt.Kernel.number_dash__greaterthan_string((plt.Kernel.setLastLoc("offset=38886 line=856 span=22 id=\"beginner-to-javascript.ss\"")   && plt.Kernel.char_dash__greaterthan_integer(a_dash_char)))),(plt.types.String.makeInstance(")))"))])); };
var string_dash__greaterthan_javascript_dash_string = function(a_dash_str) { return ((function() { 

var escape_dash_char_dash_code = function(a_dash_char) { return ((plt.Kernel.setLastLoc("offset=39143 line=865 span=19 id=\"beginner-to-javascript.ss\"") && plt.Kernel.char_equal__question_(a_dash_char,(plt.types.Char.makeInstance(String.fromCharCode(34))), [])) ?
 (plt.Kernel.setLastLoc("offset=39178 line=866 span=16 id=\"beginner-to-javascript.ss\"") && plt.Kernel.string([(plt.types.Char.makeInstance(String.fromCharCode(92))),(plt.types.Char.makeInstance(String.fromCharCode(34)))])) :
 ((plt.Kernel.setLastLoc("offset=39211 line=867 span=19 id=\"beginner-to-javascript.ss\"") && plt.Kernel.char_equal__question_(a_dash_char,(plt.types.Char.makeInstance(String.fromCharCode(92))), [])) ?
 (plt.Kernel.setLastLoc("offset=39246 line=868 span=16 id=\"beginner-to-javascript.ss\"") && plt.Kernel.string([(plt.types.Char.makeInstance(String.fromCharCode(92))),(plt.types.Char.makeInstance(String.fromCharCode(92)))])) :
 ((plt.Kernel.setLastLoc("offset=39279 line=869 span=25 id=\"beginner-to-javascript.ss\"") && plt.Kernel.char_equal__question_(a_dash_char,(plt.types.Char.makeInstance(String.fromCharCode(10))), [])) ?
 (plt.Kernel.setLastLoc("offset=39320 line=870 span=16 id=\"beginner-to-javascript.ss\"") && plt.Kernel.string([(plt.types.Char.makeInstance(String.fromCharCode(92))),(plt.types.Char.makeInstance(String.fromCharCode(110)))])) :
 (plt.types.Logic.TRUE ?
 (plt.Kernel.setLastLoc("offset=39373 line=872 span=15 id=\"beginner-to-javascript.ss\"") && plt.Kernel.string([a_dash_char])) :
 (plt.Kernel.setLastLoc("offset=39122 line=864 span=268 id=\"beginner-to-javascript.ss\"")   && plt.Kernel.error((plt.types.Symbol.makeInstance("cond")),(plt.types.String.makeInstance("cond: fell out of cond around \"offset=39122 line=864 span=268 id=\\\"beginner-to-javascript.ss\\\"\"")))))))); };
(function (toplevel_dash_expression_dash_show163) { 
 })(plt.Kernel.identity)
return (plt.Kernel.setLastLoc("offset=39397 line=873 span=189 id=\"beginner-to-javascript.ss\"") && plt.Kernel.string_dash_append([(plt.types.String.makeInstance("(plt.types.String.makeInstance(\"")),(plt.Kernel.setLastLoc("offset=39467 line=874 span=92 id=\"beginner-to-javascript.ss\"")   && string_dash_join((plt.Kernel.setLastLoc("offset=39480 line=874 span=43 id=\"beginner-to-javascript.ss\"") && plt.Kernel.map((function() { var _result_ = (function(_args_) {
                    return escape_dash_char_dash_code(_args_[0]);});_result_.toWrittenString = function(cache) {return '<function:escape-char-code>'; };_result_.toDisplayedString = _result_.toWrittenString; _result_.procedureArity = (plt.types.Rational.makeInstance(1, 1));return _result_; })(), [(plt.Kernel.setLastLoc("offset=39502 line=874 span=20 id=\"beginner-to-javascript.ss\"")   && plt.Kernel.string_dash__greaterthan_list(a_dash_str))])),(plt.types.String.makeInstance("")))),(plt.types.String.makeInstance("\"))"))]));
              })()); };
(function() { 
  ((function (toplevel_dash_expression_dash_show0) { 
...
return (plt.Kernel.setLastLoc("offset=11738 line=227 span=244 id=\"modules.ss\"")   && make_dash_module_dash_binding((plt.types.Symbol.makeInstance("world")),module_dash_path,(plt.Kernel.setLastLoc("offset=11828 line=229 span=153 id=\"modules.ss\"") && plt.Kernel.append((plt.Kernel.setLastLoc("offset=11836 line=229 span=67 id=\"modules.ss\"") && plt.Kernel.list([(plt.Kernel.setLastLoc("offset=11842 line=229 span=60 id=\"modules.ss\"")   && bf((plt.types.Symbol.makeInstance("start")),module_dash_path,(plt.types.Rational.makeInstance(10, 1)),plt.types.Logic.FALSE,(plt.types.String.makeInstance("plt.world.Bootstrap.start"))))])), [(plt.Kernel.setLastLoc("offset=11937 line=230 span=43 id=\"modules.ss\"")   && module_dash_binding_dash_bindings(world_dash_stub_dash_module))]))));
              })());
location_dash_module = ((function() { 

var module_dash_path; 
var bf = function(name, module_dash_path, arity, vararity_question_, java_dash_string) { return (plt.Kernel.setLastLoc("offset=12187 line=241 span=172 id=\"modules.ss\"")   && make_dash_binding_colon_function(name,module_dash_path,arity,vararity_question_,java_dash_string,(plt.Kernel.setLastLoc("offset=12291 line=242 span=26 id=\"modules.ss\"") && plt.Kernel.list([PERMISSION_colon_LOCATION])),plt.types.Logic.FALSE)); };
(function (toplevel_dash_expression_dash_show38) { 
module_dash_path = (plt.types.String.makeInstance("moby/geolocation"));
 })(plt.Kernel.identity)
return (plt.Kernel.setLastLoc("offset=12366 line=244 span=896 id=\"modules.ss\"")   && make_dash_module_dash_binding((plt.types.Symbol.makeInstance("location")),module_dash_path,(plt.Kernel.setLastLoc("offset=12459 line=246 span=802 id=\"modules.ss\"") && plt.Kernel.list([(plt.Kernel.setLastLoc("offset=12465 line=246 span=105 id=\"modules.ss\"")   && bf((plt.types.Symbol.makeInstance("get-latitude")),module_dash_path,(plt.types.Rational.makeInstance(0, 1)),plt.types.Logic.FALSE,(plt.types.String.makeInstance("plt.lib.Location.getLatitude")))),(plt.Kernel.setLastLoc("offset=12602 line=248 span=107 id=\"modules.ss\"")   && bf((plt.types.Symbol.makeInstance("get-longitude")),module_dash_path,(plt.types.Rational.makeInstance(0, 1)),plt.types.Logic.FALSE,(plt.types.String.makeInstance("plt.lib.Location.getLongitude")))),(plt.Kernel.setLastLoc("offset=12741 line=250 span=105 id=\"modules.ss\"")   && bf((plt.types.Symbol.makeInstance("get-altitude")),module_dash_path,(plt.types.Rational.makeInstance(0, 1)),plt.types.Logic.FALSE,(plt.types.String.makeInstance("plt.lib.Location.getAltitude")))),(plt.Kernel.setLastLoc("offset=12878 line=252 span=103 id=\"modules.ss\"")   && bf((plt.types.Symbol.makeInstance("get-bearing")),module_dash_path,(plt.types.Rational.makeInstance(0, 1)),plt.types.Logic.FALSE,(plt.types.String.makeInstance("plt.lib.Location.getBearing")))),(plt.Kernel.setLastLoc("offset=13013 line=254 span=99 id=\"modules.ss\"")   && bf((plt.types.Symbol.makeInstance("get-speed")),module_dash_path,(plt.types.Rational.makeInstance(0, 1)),plt.types.Logic.FALSE,(plt.types.String.makeInstance("plt.lib.Location.getSpeed")))),(plt.Kernel.setLastLoc("offset=13144 line=256 span=116 id=\"modules.ss\"")   && bf((plt.types.Symbol.makeInstance("location-distance")),module_dash_path,(plt.types.Rational.makeInstance(4, 1)),plt.types.Logic.FALSE,(plt.types.String.makeInstance("plt.lib.Location.getDistanceBetween"))))]))));
              })());
tilt_dash_module = ((function() { 

var module_dash_path; 
var bf = function(name, arity, vararity_question_, java_dash_string) { return (plt.Kernel.setLastLoc("offset=13448 line=266 span=166 id=\"modules.ss\"")   && make_dash_binding_colon_function(name,module_dash_path,arity,vararity_question_,java_dash_string,(plt.Kernel.setLastLoc("offset=13551 line=267 span=22 id=\"modules.ss\"") && plt.Kernel.list([PERMISSION_colon_TILT])),plt.types.Logic.TRUE)); };
(function (toplevel_dash_expression_dash_show39) { 
module_dash_path = (plt.types.String.makeInstance("moby/tilt"));
 })(plt.Kernel.identity)
return (plt.Kernel.setLastLoc("offset=13621 line=269 span=844 id=\"modules.ss\"")   && make_dash_module_dash_binding((plt.types.Symbol.makeInstance("tilt")),module_dash_path,(plt.Kernel.setLastLoc("offset=13710 line=271 span=754 id=\"modules.ss\"") && plt.Kernel.list([(plt.Kernel.setLastLoc("offset=13716 line=271 span=100 id=\"modules.ss\"")   && bf((plt.types.Symbol.makeInstance("get-x-acceleration")),(plt.types.Rational.makeInstance(0, 1)),plt.types.Logic.FALSE,(plt.types.String.makeInstance("plt.lib.Tilt.getXAcceleration")))),(plt.Kernel.setLastLoc("offset=13848 line=273 span=100 id=\"modules.ss\"")   && bf((plt.types.Symbol.makeInstance("get-y-acceleration")),(plt.types.Rational.makeInstance(0, 1)),plt.types.Logic.FALSE,(plt.types.String.makeInstance("plt.lib.Tilt.getYAcceleration")))),(plt.Kernel.setLastLoc("offset=13980 line=275 span=104 id=\"modules.ss\"")   && bf((plt.types.Symbol.makeInstance("get-z-acceleration")),(plt.types.Rational.makeInstance(0, 1)),plt.types.Logic.FALSE,(plt.types.String.makeInstance("plt.lib.Location.getZAcceleration")))),(plt.Kernel.setLastLoc("offset=14148 line=278 span=87 id=\"modules.ss\"")   && bf((plt.types.Symbol.makeInstance("get-azimuth")),(plt.types.Rational.makeInstance(0, 1)),plt.types.Logic.FALSE,(plt.types.String.makeInstance("plt.lib.Tilt.getAzimuth")))),(plt.Kernel.setLastLoc("offset=14267 line=280 span=83 id=\"modules.ss\"")   && bf((plt.types.Symbol.makeInstance("get-pitch")),(plt.types.Rational.makeInstance(0, 1)),plt.types.Logic.FALSE,(plt.types.String.makeInstance("plt.lib.Tilt.getPitch")))),(plt.Kernel.setLastLoc("offset=14382 line=282 span=81 id=\"modules.ss\"")   && bf((plt.types.Symbol.makeInstance("get-roll")),(plt.types.Rational.makeInstance(0, 1)),plt.types.Logic.FALSE,(plt.types.String.makeInstance("plt.lib.Tilt.getRoll"))))]))));
              })());
...
return (plt.Kernel.setLastLoc("offset=14564 line=293 span=567 id=\"modules.ss\"")   && make_dash_module_dash_binding((plt.types.Symbol.makeInstance("telephony")),module_dash_path,(plt.Kernel.setLastLoc("offset=14658 line=295 span=472 id=\"modules.ss\"") && plt.Kernel.list([(plt.Kernel.setLastLoc("offset=14664 line=295 span=465 id=\"modules.ss\"")   && make_dash_binding_colon_function((plt.types.Symbol.makeInstance("get-signal-strengths")),module_dash_path,(plt.types.Rational.makeInstance(0, 1)),plt.types.Logic.FALSE,(plt.types.String.makeInstance("plt.lib.Telephony.getSignalStrengths")),(plt.Kernel.setLastLoc("offset=15041 line=300 span=27 id=\"modules.ss\"") && plt.Kernel.list([PERMISSION_colon_TELEPHONY])),plt.types.Logic.FALSE))]))));
              })());
...
return (plt.Kernel.setLastLoc("offset=15218 line=311 span=529 id=\"modules.ss\"")   && make_dash_module_dash_binding((plt.types.Symbol.makeInstance("net")),module_dash_path,(plt.Kernel.setLastLoc("offset=15306 line=313 span=440 id=\"modules.ss\"") && plt.Kernel.list([(plt.Kernel.setLastLoc("offset=15312 line=313 span=433 id=\"modules.ss\"")   && make_dash_binding_colon_function((plt.types.Symbol.makeInstance("get-url")),module_dash_path,(plt.types.Rational.makeInstance(1, 1)),plt.types.Logic.FALSE,(plt.types.String.makeInstance("plt.lib.Net.getUrl")),(plt.Kernel.setLastLoc("offset=15658 line=318 span=26 id=\"modules.ss\"") && plt.Kernel.list([PERMISSION_colon_INTERNET])),plt.types.Logic.FALSE))]))));
              })());
...
return (plt.Kernel.setLastLoc("offset=15836 line=325 span=989 id=\"modules.ss\"")   && make_dash_module_dash_binding((plt.types.Symbol.makeInstance("parser")),module_dash_path,(plt.Kernel.setLastLoc("offset=15927 line=327 span=897 id=\"modules.ss\"") && plt.Kernel.list([(plt.Kernel.setLastLoc("offset=15933 line=327 span=420 id=\"modules.ss\"")   && make_dash_binding_colon_function((plt.types.Symbol.makeInstance("xml->s-exp")),module_dash_path,(plt.types.Rational.makeInstance(1, 1)),plt.types.Logic.FALSE,(plt.types.String.makeInstance("plt.lib.Parser.parseXml")),plt.types.Empty.EMPTY,plt.types.Logic.FALSE))]))));
              })());
jsworld_dash_module = ((function() { 

var module_dash_path; 
var bf = function(name, arity, java_dash_string) { return (plt.Kernel.setLastLoc("offset=16969 line=347 span=75 id=\"modules.ss\"")   && make_dash_binding_colon_function(name,module_dash_path,arity,plt.types.Logic.TRUE,java_dash_string,plt.types.Empty.EMPTY,plt.types.Logic.FALSE)); };
(function (toplevel_dash_expression_dash_show43) { 
module_dash_path = (plt.types.String.makeInstance("moby/jsworld"));
 })(plt.Kernel.identity)
return (plt.Kernel.setLastLoc("offset=17051 line=348 span=1610 id=\"modules.ss\"")   && make_dash_module_dash_binding((plt.types.Symbol.makeInstance("jsworld")),module_dash_path,(plt.Kernel.setLastLoc("offset=17143 line=350 span=1517 id=\"modules.ss\"") && plt.Kernel.list([(plt.Kernel.setLastLoc("offset=17149 line=350 span=324 id=\"modules.ss\"")   && make_dash_binding_colon_function((plt.types.Symbol.makeInstance("js-big-bang")),module_dash_path,(plt.types.Rational.makeInstance(1, 1)),plt.types.Logic.TRUE,(plt.types.String.makeInstance("plt.world.MobyJsworld.bigBang")),plt.types.Empty.EMPTY,plt.types.Logic.FALSE)),(plt.Kernel.setLastLoc("offset=17505 line=358 span=421 id=\"modules.ss\"")   && make_dash_binding_colon_function((plt.types.Symbol.makeInstance("js-text")),module_dash_path,(plt.types.Rational.makeInstance(1, 1)),plt.types.Logic.FALSE,(plt.types.String.makeInstance("plt.world.MobyJsworld.text")),plt.types.Empty.EMPTY,plt.types.Logic.FALSE)),(plt.Kernel.setLastLoc("offset=18165 line=370 span=42 id=\"modules.ss\"")   && bf((plt.types.Symbol.makeInstance("js-div")),(plt.types.Rational.makeInstance(0, 1)),(plt.types.String.makeInstance("plt.world.MobyJsworld.div")))),(plt.Kernel.setLastLoc("offset=18239 line=371 span=38 id=\"modules.ss\"")   && bf((plt.types.Symbol.makeInstance("js-p")),(plt.types.Rational.makeInstance(0, 1)),(plt.types.String.makeInstance("plt.world.MobyJsworld.p")))),(plt.Kernel.setLastLoc("offset=18309 line=372 span=48 id=\"modules.ss\"")   && bf((plt.types.Symbol.makeInstance("js-button")),(plt.types.Rational.makeInstance(1, 1)),(plt.types.String.makeInstance("plt.world.MobyJsworld.button")))),(plt.Kernel.setLastLoc("offset=18389 line=373 span=53 id=\"modules.ss\"")   && bf((plt.types.Symbol.makeInstance("js-button!")),(plt.types.Rational.makeInstance(2, 1)),(plt.types.String.makeInstance("plt.world.MobyJsworld.buttonStar")))),(plt.Kernel.setLastLoc("offset=18474 line=374 span=46 id=\"modules.ss\"")   && bf((plt.types.Symbol.makeInstance("js-input")),(plt.types.Rational.makeInstance(2, 1)),(plt.types.String.makeInstance("plt.world.MobyJsworld.input")))),(plt.Kernel.setLastLoc("offset=18531 line=375 span=49 id=\"modules.ss\"")   && bf((plt.types.Symbol.makeInstance("js-img")),(plt.types.Rational.makeInstance(1, 1)),(plt.types.String.makeInstance("plt.world.MobyJsworld.img")))),(plt.Kernel.setLastLoc("offset=18612 line=377 span=47 id=\"modules.ss\"")   && bf((plt.types.Symbol.makeInstance("js-node")),(plt.types.Rational.makeInstance(1, 1)),(plt.types.String.makeInstance("plt.world.MobyJsworld.rawNode"))))]))));
              })());
moby_dash_module_dash_binding = (plt.Kernel.setLastLoc("offset=18795 line=385 span=401 id=\"modules.ss\"")   && make_dash_module_dash_binding((plt.types.Symbol.makeInstance("moby")),(plt.types.String.makeInstance("moby/moby")),(plt.Kernel.setLastLoc("offset=18880 line=387 span=315 id=\"modules.ss\"") && plt.Kernel.append((plt.Kernel.setLastLoc("offset=18913 line=388 span=43 id=\"modules.ss\"")   && module_dash_binding_dash_bindings(world_dash_stub_dash_module)), [(plt.Kernel.setLastLoc("offset=18981 line=389 span=40 id=\"modules.ss\"")   && module_dash_binding_dash_bindings(jsworld_dash_module)),(plt.Kernel.setLastLoc("offset=19046 line=390 span=42 id=\"modules.ss\"")   && module_dash_binding_dash_bindings(telephony_dash_module)),(plt.Kernel.setLastLoc("offset=19113 line=391 span=41 id=\"modules.ss\"")   && module_dash_binding_dash_bindings(location_dash_module)),(plt.Kernel.setLastLoc("offset=19158 line=392 span=36 id=\"modules.ss\"")   && module_dash_binding_dash_bindings(net_dash_module))]))));

known_dash_modules = (plt.Kernel.setLastLoc("offset=19771 line=411 span=397 id=\"modules.ss\"") && plt.Kernel.list([world_dash_module,world_dash_stub_dash_module,location_dash_module,tilt_dash_module,net_dash_module,parser_dash_module,bootstrap_dash_module,telephony_dash_module,moby_dash_module_dash_binding]));
