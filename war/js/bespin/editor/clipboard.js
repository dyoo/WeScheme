...
dojo.mixin(bespin.editor.clipboard, {
    ...
    setup: function(editor) {
        ...
        // OUCH
        //
        // For now, always using the HiddenWorld as:
        // Safari Win doesn't support setData() https://bugs.webkit.org/show_bug.cgi?id=17645
        // WebKit Nightly just stopped working with setData() too
        //
        // if (dojo.isWebKit) {
...
dojo.declare("bespin.editor.clipboard.DOMEvents", null, {
    install: function(editor) {
        ...
        var copynpaster = this.copynpaster = bespin.editor.clipboard.createHiddenTextarea(); 
